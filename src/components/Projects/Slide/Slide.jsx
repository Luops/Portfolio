    ...
    >
      {projects.map((project) => (
        <SwiperSlide
          ...
          className="relative flex !z-0 w-[150px] mx-10 h-[80px] bg-[rgba(0,0,0,0.1)] border border-cyan-400 shadow-[0_0_5px_#0000003e] mt-20 cursor-pointer items-center justify-center rounded-3xl"
        >
          ...
          {project.logo.length === 0 ? (
            ...
            <img
              className="absolute bottom-[10px] w-20 rounded-[40%]"
              src={project.logo}
              alt=""
            />
          )}
